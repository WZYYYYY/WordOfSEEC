...
##### 5.3.2.5 RechargeService模块的接口规范
...
##### 5.3.2.6 PayRecordService模块的接口规范
...
|                                            | **前置条件** | 输入符合规则                                                 |
|                                            | **后置条件** | 将退票策略保存到数据库中                                     |
| RefchargeMapper.selectRechargerecordByUser | **语法**     | List<Rechargerecord> selectRechargerecordByUser(int UserID); |
|                                            | **前置条件** | 输入符合规则                                                 |
|                                            | **后置条件** | 返回充值记录                                                 |
